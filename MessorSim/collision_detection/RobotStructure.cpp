...
/*!\brief makes 4x4 transform matrix
  */
CPunctum CRobotStructure::makeTransformMatrix(const char * type, float value){
  CPunctum tmp;
  tmp.setEye();
  float x,y,z;
  if (!strcmp(type,"x")){
...
void CRobotStructure::Noga_3(float Qn_1, float Qn_2, float Qn_3, CPunctum * m_noga)
{
									float przegub_c3[16];
									CPunctum m_noga1;
									m_noga1 = (*m_noga)*makeTransformMatrix("gamma", Qn_1*3.14/180);
									...
									CPunctum m_noga2;
									m_noga2 = m_noga1 * makeTransformMatrix("alpha", -3.14/2)*makeTransformMatrix("x", -2.15*0.254)*makeTransformMatrix("y", -0.49*0.254)*makeTransformMatrix("z", 0.92*0.254)*makeTransformMatrix("gamma", Qn_2*3.14/180);
									copyTable(&m_noga2,czlon1_m3);
									robot_model.segment_II_model_3->setTransform (czlon1_m3);
									float segment3[16];
									CPunctum m_noga3;
									m_noga3 = m_noga2 * makeTransformMatrix("x", -6.28*0.254)*makeTransformMatrix("z", -1.69*0.254)*makeTransformMatrix("gamma", Qn_3*3.14/180);
									copyTable(&m_noga3,segment3);
									robot_model.segment_I_model_3->setTransform (segment3);

								CPunctum m_noga4;
								m_noga4 = m_noga3 * makeTransformMatrix("x", -7.9*0.254)*makeTransformMatrix("y", -0.03*0.254)*makeTransformMatrix("z", 0.76*0.254)*makeTransformMatrix("beta", 90*3.14/180)*makeTransformMatrix("alpha", -28.6*3.14/180)*makeTransformMatrix("z", -0.45*0.254);
									float stopka_3[16];
...
void CRobotStructure::Noga_4(float Qn_1, float Qn_2, float Qn_3, CPunctum * m_noga)
{
						float przegub_c4[16];
									CPunctum m_noga1;
									m_noga1 = (*m_noga)*makeTransformMatrix("gamma", Qn_1*3.14/180);
						...
						float czlon1_m4[16];
								...
								float stopka_4[16];
									CPunctum m_noga4;
									m_noga4 = m_noga3 * makeTransformMatrix("x", -7.9*0.254)*makeTransformMatrix("y", -0.03*0.254)*makeTransformMatrix("z", 0.8*0.254)*makeTransformMatrix("beta", 90*3.14/180)*makeTransformMatrix("alpha", -28.6*3.14/180)*makeTransformMatrix("z", -0.45*0.254);
									copyTable(&m_noga4,stopka_4);

									robot_model.stopka_4_model->setTransform (stopka_4);
}

void CRobotStructure::Noga_2(float Qn_1, float Qn_2, float Qn_3, CPunctum * m_noga)
{
						float przegub_c2[16];
...
void CRobotStructure::Noga_5(float Qn_1, float Qn_2, float Qn_3, CPunctum * m_noga)
{
						float przegub_c5[16];
									CPunctum m_noga1;
									m_noga1 = (*m_noga)*makeTransformMatrix("gamma", Qn_1*3.14/180);
...
void CRobotStructure::Noga_1(float Qn_1, float Qn_2, float Qn_3, CPunctum * m_noga)
{
						float przegub_c1[16];
									CPunctum m_noga1;
									m_noga1 = (*m_noga)*makeTransformMatrix("gamma", Qn_1*3.14/180);
...
void CRobotStructure::Noga_6(float Qn_1, float Qn_2, float Qn_3, CPunctum * m_noga)
{
						float przegub_c6[16];
									CPunctum m_noga1;
									m_noga1 = (*m_noga)*makeTransformMatrix("gamma", Qn_1*3.14/180);
